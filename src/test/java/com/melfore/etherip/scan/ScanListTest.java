 ...
 *******************************************************************************/
package com.melfore.etherip.scan;
...
import com.melfore.etherip.Tag;
import com.melfore.etherip.TagListener;
...
public class ScanListTest implements TagListener {
	...
	public void setup() throws Exception {
		...
		this.connection = new TcpConnection(TestSettings.get("plc"), TestSettings.getInt("slot"));
	...
	public void testScanListRead() throws Exception {
		...
		assertEquals(this.updates.getCount(), 0l);
	...
	public void testScanListError() throws Exception {
		...
		assertEquals(this.errors.getCount(), 0l);
