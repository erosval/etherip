...
import static com.melfore.etherip.protocol.Encapsulation.Command.UnRegisterSession;
import static com.melfore.etherip.types.CNPath.MessageRouter;
import static com.melfore.etherip.types.CNService.Get_Attribute_All;
import static com.melfore.etherip.types.CNService.Get_Attribute_Single;
...
import com.melfore.etherip.data.CipException;
import com.melfore.etherip.data.ConnectionData;
import com.melfore.etherip.data.EthernetLink;
import com.melfore.etherip.data.Identity;
import com.melfore.etherip.data.InterfaceConfiguration;
import com.melfore.etherip.data.TcpIpInterface;
import com.melfore.etherip.protocol.CIPMultiRequestProtocol;
import com.melfore.etherip.protocol.Connection;
import com.melfore.etherip.protocol.ConnectionDataProtocol;
import com.melfore.etherip.protocol.Encapsulation;
import com.melfore.etherip.protocol.GetConnectionDataProtocol;
import com.melfore.etherip.protocol.GetEthernetLinkProtocol;
import com.melfore.etherip.protocol.GetHexStringDataProtocol;
import com.melfore.etherip.protocol.GetIdentityProtocol;
import com.melfore.etherip.protocol.GetIntAttributeProtocol;
import com.melfore.etherip.protocol.GetInterfaceConfigurationProtocol;
import com.melfore.etherip.protocol.GetPhysicalLinkObjectProtocol;
import com.melfore.etherip.protocol.GetShortAttributeProtocol;
import com.melfore.etherip.protocol.GetStringAttributeProtocol;
import com.melfore.etherip.protocol.GetTcpIpInterfaceProtocol;
import com.melfore.etherip.protocol.ListIdenties;
import com.melfore.etherip.protocol.ListServices;
import com.melfore.etherip.protocol.MRChipReadProtocol;
import com.melfore.etherip.protocol.MRChipWriteProtocol;
import com.melfore.etherip.protocol.MessageRouterProtocol;
import com.melfore.etherip.protocol.Protocol;
import com.melfore.etherip.protocol.ProtocolAdapter;
import com.melfore.etherip.protocol.RegisterSession;
import com.melfore.etherip.protocol.SendRRDataProtocol;
import com.melfore.etherip.protocol.TcpConnection;
import com.melfore.etherip.protocol.UdpConnection;
import com.melfore.etherip.protocol.UnconnectedSendProtocol;
import com.melfore.etherip.protocol.ListServicesProtocol.Service;
import com.melfore.etherip.types.CIPData;
import com.melfore.etherip.types.CNClassPath;
import com.melfore.etherip.types.CNPath;
